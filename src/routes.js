...
const routes = [
  ...
  { path: '/productnamesetup', exact: true, name: 'Product Name Setup', component: Category },
  { path: '/catalognumbersetup', exact: true, name: 'Catalog Number Setup', component: Subcategory },
