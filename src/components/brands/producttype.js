...
import EditModal from './producttypeeditmodal';
import { useDispatch, useSelector } from 'react-redux';
import { clearSuccess, getSubcategories } from 'src/store/actions/appactions';
import moment from 'moment';
import Delete from './deletecategory';
  ...
  return (
      ...
      <EditModal show={showedit} close={handleClosedit} brand={brand}/>
          ...
          <CPagination
            ...
            pages={app.subcategories ? parseInt(app.subcategories.length / 4) + 1 : 4}
            doubleArrows={false} 
            align="center"
          />
