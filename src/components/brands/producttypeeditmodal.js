...
import { editSubcategory } from 'src/store/actions/appactions';
  ...
  return (
            ...
            >
              <CModalHeader closeButton>
                <CModalTitle>Edit {brand.title} Product Type</CModalTitle>
              </CModalHeader>
              <CModalBody>
              <CCol xs="12">
              <CRow>
              {app.error && app.error.type === 'subcategoryediterror' ?  <CCol xs='12'>
                ...
                Product Type Edited successfully
              </CAlert>
                </CCol> : null}
                <CCol xs="12">
                  <CFormGroup>
