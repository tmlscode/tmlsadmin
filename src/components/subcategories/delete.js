...
import {deleteCategory } from '../../store/actions/appactions';
...
const Modals = ({show, close, brand}) => {
  ...
  const onSubmit = () => {
    dispatch(deleteCategory(app.user.token, brand._id));
  }
  ...
  >
    <CModalHeader closeButton>
      <CModalTitle>Delete Catalog</CModalTitle>
    </CModalHeader>
    <CModalBody>
    <CRow>
      ...
      Are you sure you want to delete {brand ? brand.catalognumber : null}?
    </CModalBody>
    <CModalFooter>
